...
const COORDINATE_PRESETS = [
  ...
  },
  {
    ...
    reason: 'ウールライクダウン×白ニットで上品な防寒。スマートパンツで崩さない。',
    bodyTip: 'ダウンのボリュームに白ニットで顔周りの明るさを確保。グレーの996がバランス。',
  },
  {
    id: 'c07c',
    season: 'winter',
    ...
    reason: '防風ジャケット×モックネックのミニマルブラック。近所使いに最適。',
    bodyTip: 'モックネックが首の貧弱さをカバー。全身ブラックでも素材の違いでのっぺりしない。',
  },
  {
    id: 'c07d',
    season: 'winter',
    ...
    reason: 'ダウンパーカ×黒スウェットの最小構成。ダークブラウンパンツで単調さ回避。',
    bodyTip: 'スウェットMサイズでゆとりがちょうどいい。ダウンSサイズで着膨れしない。',
  },
  {
    id: 'c07e',
    season: 'winter',
    ...
    reason: '防風ジャケット×フリースの実用全振り。子どもと全力で遊べる構成。',
    bodyTip: 'フリースのクルーネックでスッキリ。ジャストSサイズで動きやすい。',
  },
...

  {
    ...
    reason: '白カットソー1枚×キャロットスラックスで最小限のきちんと感。',
    bodyTip: '白カットソーMサイズがジャスト。スラックスXSで脚線が整う。',
  },
  {
    id: 'c10b',
    season: 'spring',
    ...
    reason: 'スタンドブルゾン×白T×スウェットパンツで動きやすさ重視。NB996できれいめを維持。',
    bodyTip: 'スタンドカラーで首元に高さ。スウェットパンツでも黒で締まる。',
  },
  {
    id: 'c10c',
    season: 'spring',
    ...
    reason: 'オリーブシャツ1枚で春らしい色味。タックワイドテーパードで大人のゆとり。',
    bodyTip: 'シャツの着丈で腰位置を曖昧に。テーパードのXSで脚がスッキリ。',
  },
  {
    id: 'c11b',
    season: 'spring',
    ...
    reason: 'スエードジャケット×黒カットソーの春アウターコーデ。スラックスで下半身はきちんと。',
    bodyTip: 'ショートジャケットの丈で脚長効果。ブラック×ブラックで統一。',
  },
  {
    id: 'c12b',
    season: 'spring',
    ...
    reason: 'カーディガン×白カットソー×ローファーの大人カジュアルきれいめ。',
    bodyTip: 'XSカーディガンが肩にジャスト。ローファーで足元に格を出す。',
  },
...

  {
    ...
    reason: '黒T×タックテーパードのモノトーン。NB996のグレーが抜けに。',
    bodyTip: '黒Tは引き締め効果。タックテーパードSで腰位置を高く見せる。',
  },
  {
    id: 'c13c',
    season: 'summer',
    ...
    reason: '白T×ギアパンツの最小構成。清潔感だけは死守。',
    bodyTip: 'ギアパンツの機能素材で涼しく。白Tで顔の印象を明るく。',
  },
  {
    id: 'c14b',
    season: 'summer',
    ...
    reason: '白T×ギアパンツ×NB996。キャップで日差し対策。白×黒×グレーの3色。',
    bodyTip: '白Tで爽やかさ。ギアパンツで子どもと走り回れる。',
  },
  {
    id: 'c14c',
    season: 'summer',
    ...
    reason: 'デニムT×ギアパンツの最カジュアル構成。サファリハットで夏感。',
    bodyTip: 'デニムTの素材感で手抜き感なし。ギアパンツで実用全振り。',
  },
  {
    id: 'c15b',
    season: 'summer',
    ...
    reason: '白T×タックテーパードの夏ミニマル。シンプルだが品がある。',
    bodyTip: '白×黒の2色で清潔感重視。タックのゆとりで涼しげ。',
  },
  {
    id: 'c16b',
    season: 'summer',
    ...
    reason: 'オープンカラーシャツ×テーパード×ローファー。黒のワントーンで夏の大人感。',
    bodyTip: 'オープンカラーの開きが首元をスッキリ見せる。ローファーで格上げ。',
  },
  ...
  },
  {
    ...
    reason: 'スタンドブルゾン×ミラノリブのスマートカジュアル。スラックスで下半身はきちんと。',
    bodyTip: 'スタンドカラーで首元に立体感。ミラノリブのハリで上半身を整える。',
  },
  {
    id: 'c17c',
    season: 'autumn',
    ...
    reason: 'ユーティリティシャツ1枚×スマートパンツ。ダークグレーの同系色でまとめる。',
    bodyTip: 'シャツのゆとりが適度。スマートパンツのセンタープレスで全体を引き締め。',
  },
  {
    id: 'c18b',
    season: 'autumn',
    ...
    reason: 'MA-1×ネイビースウェットの秋カジュアル。ボディバッグで身軽に。',
    bodyTip: 'MA-1の丈が胴長を目立たせない。スウェットのゆとりで動きやすい。',
  },
  {
    id: 'c18c',
    season: 'autumn',
    ...
    reason: 'フーデッドブルゾン×黒カットソー×スウェットパンツで全力アクティブ構成。',
    bodyTip: 'フード付きで首元カバー。スウェットパンツでもXSで脚線が崩れない。',
  },
  {
    id: 'c19b',
    season: 'autumn',
    ...
    reason: 'カバーオール×白カットソーの秋きれいめカジュアル。スラックスで品格。',
    bodyTip: 'カバーオールの肩線で骨格補正。白×黒のコントラストで清潔感。',
  },
  {
    id: 'c19c',
    season: 'autumn',
    ...
    reason: 'シャツジャケット1枚のミニマル構成。ブラウンで秋の色味。',
    bodyTip: 'シャツジャケットのハリが上半身にボリューム。テーパードで下半身スッキリ。',
  },
  {
    id: 'c20b',
    season: 'autumn',
    ...
    reason: 'カバーオール×グレーミラノリブ×ローファー。ブラック×グレーの大人配色。',
    bodyTip: 'カバーオールの構築的な肩線。グレーニットで顔色を良く。',
  },
  {
    id: 'c20c',
    season: 'autumn',
    ...
    reason: 'スエードジャケット×ミラノリブネイビーのシンプル構成。スマートパンツで崩さない。',
    bodyTip: 'ショートジャケットで脚長効果。ネイビーニットで落ち着き。',
  },
];
